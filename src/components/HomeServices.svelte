...
<section id="services" class="py-20 bg-white">
    <div class="container mx-auto px-4">
        ...
        {#each serviceChunks as chunk}
            ...
            <div class="flex justify-center items-center flex-col lg:flex-row gap-4 mb-8">
                {#each chunk as service}
                    <button on:click={() => openPopup(service)} class="group w-full max-w-[350px] bg-white p-8 rounded-xl shadow-md hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 text-center focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
