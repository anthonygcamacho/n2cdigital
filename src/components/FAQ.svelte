...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
    ...
    <div class="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
        <div class="border-b border-gray-200 py-6">
            {#each FAQS as faq}
                <div class="mb-4">
                    <button class="w-full flex justify-between items-center text-left text-lg font-semibold text-gray-800 focus:outline-none" aria-expanded="false">
                        <span>{faq.question}</span>
                        <span class="transform transition-transform duration-300 rotate-0">
