...
<section id="contact-us" class="py-20 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="flex flex-col items-start justify-center items-center rounded-lg shadow-lg">
                ...
                {#if !success}
                <form on:submit|preventDefault={handleSubmit} class="w-full bg-white text-gray-800 p-8 pt-0">
                ...
                {/if}
                {#if success}
                    <div class="w-full bg-white text-gray-800 p-8 pt-0 text-left">
